...
+===================================================================================================+
| 2026-01-22T18:20:57+08:00 | 转账 | 53.62  | CNY  | 9097招行   | -    | 其他 | -    | 7ypsr1gftsyi |
|---------------------------+------+--------+------+------------+------+------+------+--------------|
| 2026-01-22T18:17:29+08:00 | 转账 | -4.18  | CNY  | 医保（京） | -    | 其他 | -    | v1nwvfli4b5h |
|---------------------------+------+--------+------+------------+------+------+------+--------------|
| 2026-01-22T18:17:12+08:00 | 转账 | -65.65 | CNY  | 微信钱包   | -    | 其他 | -    | pf55f8xys2s2 |
|---------------------------+------+--------+------+------------+------+------+------+--------------|
| 2026-01-22T18:17:05+08:00 | 转账 | -233   | CNY  | 支付宝余额 | -    | 其他 | -    | 3h2m4cir5v7u |
|---------------------------+------+--------+------+------------+------+------+------+--------------|
| 2026-01-22T18:16:33+08:00 | 转账 | -200   | CNY  | 数字人民币 | -    | 其他 | -    | 7w55bahg67tx |
+---------------------------+------+--------+------+------------+------+------+------+--------------+
共 5 条记录
```
...
- **金额**：转账类型可能显示负数（表示资金流出）
- **ID 位置**：表格最后一列，便于复制使用
- **短 ID**：显示 Record ID 的前 12 位（如 `7ypsr1gftsyi`），平衡可读性与唯一性
