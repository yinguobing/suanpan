...
use suanpan::commands::{
    account, add, category, compare, import, list, migrate, remove, report, stats, tag, trend,
    update, Cli, Commands,
};
...
fn get_data_dir() -> Result<PathBuf> {
    let base_dir = data_dir().ok_or_else(|| anyhow::anyhow!("无法获取数据目录"))?;
